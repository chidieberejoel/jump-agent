...
#
#     PHX_SERVER=true bin/jump_agent start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :jump_agent, JumpAgentWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :jump_agent, JumpAgent.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :jump_agent, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :langchain,
    ...
    config :jump_agent,
       webhook_verify_token: System.get_env("WEBHOOK_VERIFY_TOKEN") || "jump_agent_webhook_token"
  ...
  #
  #     config :jump_agent, JumpAgent.Mailer,
